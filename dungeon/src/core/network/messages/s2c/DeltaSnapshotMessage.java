 ...
 *
 * <p>Delta snapshots are sent at a high frequency (e.g., 90Hz) via UDP, while full snapshots are
 * sent periodically (e.g., every 1 second) via TCP to ensure eventual consistency.
 *
