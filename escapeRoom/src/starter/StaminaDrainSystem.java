...
public class StaminaDrainSystem extends System {
   ...
   *
   * <p>The drain amount is calculated as: {@code drainRate / Game.tickRate()} to ensure
   * tick-rate-independent behavior.
   *
  ...
  private void drainStamina(Entity entity) {
    ...
    // Apply tick-rate-independent drain
    float drainAmount = drainRate / Game.tickRate();
